...
def nova_extracao(link, cursor, sheet):
    try:
        ...
        valores = (
            ...
            'Zetta ML'  # Valor da nova coluna origem
        )
        ...
        sheet[f'F{proxima_linha}'] = 'Zetta ML'  # Valor da nova coluna origem
...
def configure_spreadsheets():
    try:
        ...
        planilha = pd.read_excel('Produtos_Zetta.xlsx')

        # Carregando a planilha de produtos existente
        workbook = openpyxl.load_workbook('02.Output_informacoes_produtos_zetta.xlsx')
...
if __name__ == "__main__":
    try:
        ...
        # Salvando a planilha
        workbook.save('02.Output_informacoes_produtos_zetta.xlsx')
